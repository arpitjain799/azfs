...
def _generate_parameter_args(
    ...
    args_dict = [
        {"kwrd": "storage_account", "_type": "str", "exp": "storage account", "default": storage_account},
        {"kwrd": "storage_type", "_type": "str", "exp": "`blob` or `dfs`", "default": storage_type},
        {"kwrd": "container", "_type": "str", "exp": "container", "default": container},
        {"kwrd": "key", "_type": "str", "exp": "as same as folder name", "default": key},
        {
        ...
        {"kwrd": "file_name", "_type": "str, List[str]", "exp": "file_name", "default": file_name},
        {
        ...
        {"kwrd": "export", "_type": "bool", "exp": "export if True", "default": export},
        {"kwrd": "format_type", "_type": "str", "exp": "`csv` or `pickle`", "default": format_type},
    ]
    ...
    if additional_args is not None:
        ...
        args_list.extend([f"{indent_}_{additional_args}{basic_args_.format(**d)}" for d in args_dict])
        return "".join(args_list)
    else:
        args_list = [
            f"\n        == params for default ==",
        ]
        args_list.extend([f"{indent_}{basic_args_.format(**d)}" for d in args_dict])
        return "".join(args_list)
